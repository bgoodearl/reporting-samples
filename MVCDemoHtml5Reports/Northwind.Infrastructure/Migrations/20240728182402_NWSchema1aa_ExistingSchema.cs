...
{
    /// <inheritdoc />
    public partial class NWSchema1aa_ExistingSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerTypeID = table.Column<string>(type: "nchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegionDescription = table.Column<string>(type: "nchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerDemographicsCustomerTypeID = table.Column<string>(type: "nchar(10)", nullable: false),
                    CustomersCustomerID = table.Column<string>(type: "nchar(5)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerCustomerDemographic", x => new { x.CustomerDemographicsCustomerTypeID, x.CustomersCustomerID });
                    table.ForeignKey(
                        name: "FK_CustomerCustomerDemographic_CustomerDemographics_CustomerDemographicsCustomerTypeID",
                        column: x => x.CustomerDemographicsCustomerTypeID,
                        principalTable: "CustomerDemographics",
                        principalColumn: "CustomerTypeID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerCustomerDemographic_Customers_CustomersCustomerID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TerritoryDescription = table.Column<string>(type: "nchar(50)", maxLength: 50, nullable: false),
                    RegionID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscontinuedDate = table.Column<DateTime>(type: "date", nullable: true)
                },
                constraints: table =>
                {
